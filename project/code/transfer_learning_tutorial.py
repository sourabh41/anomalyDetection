...
class myModel(nn.Module):
    ...
    def forward(self,x):
        ...
        out1 = self.classifier[0:3](out1)
        out1 = out1.view(out1.size(0), 128*13*13) 
        out1 = self.classifier[3:](out1)
        return out1
...
model_conv = myModel()
model_conv.conv1.requires_grad = False
model_conv.relu1.requires_grad = False
model_conv.maxpool1.requires_grad = False
model_conv.conv2.requires_grad = False
model_conv.relu2.requires_grad = False
